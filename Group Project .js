...
function draw() {
  background(10, 10, 30);   // Dark background color
 ...
 // If game is over, display game over screen and score
  if (gameOver) {
    fill(255);
    textAlign(CENTER);
    textSize(48);
...
// Handle key presses for player movement and restarting game
function keyPressed() {
  if (keyCode === LEFT_ARROW) {
    ...
    restartGame(); // Restart game when 'R' pressed
  }
}
